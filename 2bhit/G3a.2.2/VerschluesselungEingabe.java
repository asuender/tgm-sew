...
public class VerschluesselungEingabe {
    public static void main(String[] args) {
        ...
        Verschluesselung obj = new Verschluesselung();
        
        switch (choiceNum) {
            case 1:
                output += obj.verschluesseln(input);
                break;
            case 2:
                shift = Integer.parseInt(Input.readLine("Der Verschiebewert (1-25):", 1));
                obj.setKey(shift);
                output += obj.verschluesseln(input);
                break;
            case 3:
                ...
                break;
            case 4:
                output += obj.entschluesseln(input);
                break;
            case 5:
                shift = Integer.parseInt(Input.readLine("Der Verschiebewert (1-25):", 1));
                obj.setKey(shift);
